...
const main = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (typeof serverJson !== 'string') {
        console.error('provide path to server.json as an argument');
        return;
    }
    console.log(`converting file ${serverJson}...`);
    const contents = yield fs.promises.readFile(serverJson, 'utf-8');
    ...
    yield fs.promises.writeFile(zoweDotYamlFile, zoweYamlData);
    console.log('done');
});
